...
public class Join extends HashMap<String, Object>{
	...
	public Join(HashMap<? extends String, ? extends Object> t) {
		super(t);
	}
	
	public static Join toParam(String alias, Object object){
	...
	public Join(String key, Object value){
		super.put(key, value);
