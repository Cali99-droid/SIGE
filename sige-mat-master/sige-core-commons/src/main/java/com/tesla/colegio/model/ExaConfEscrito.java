...
/**
 * Clase entidad que representa a la tabla eva_exa_conf_escrito
 * @author MV
 *
 */
public class ExaConfEscrito extends EntidadBase{

	public final static String TABLA = "eva_exa_conf_escrito";
	private Integer id;
