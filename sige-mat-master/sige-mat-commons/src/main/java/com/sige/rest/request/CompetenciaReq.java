...
public class CompetenciaReq implements Serializable{
	...
	public List<CapacidadReq> getNodes() {
		return nodes;
	}
	public void setNodes(List<CapacidadReq> nodes) {
		this.nodes = nodes;
	}
