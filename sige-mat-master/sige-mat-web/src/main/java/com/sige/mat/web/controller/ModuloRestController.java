...
import com.sige.mat.dao.ModuloDAO;
...
public class ModuloRestController {
	...
	@RequestMapping(value = "/listarModulos")
	public AjaxResponseBody getListaModulos(Modulo modulo) {

		AjaxResponseBody result = new AjaxResponseBody();
		 
		result.setResult(moduloDAO.listByParams(null, null));
