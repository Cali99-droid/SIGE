...
function config_editar(row,e){
	...
	var link = $(row);
	link.attr('href','pages/olimpiada/oli_config_form.html');
	config_modal(link);
				...
				$('#oli_config-tabla').dataTable({
			         ...
			         columns : [ 
							...
							{"title":"Acciones", "render": function ( data, type, row ) {
								return '<div class="list-icons"> <a href="#" data-id="' + row.id + '" onclick="_send(\'pages/olimpiada/oli_config_form.html\',\'Configuración Concurso\',\'Configuración Concurso\',{id:'+row.id+'});" class="list-icons-item"><i class="fa fa-pencil ui-blue ui-size" aria-hidden="true"></i></a>'+ 
