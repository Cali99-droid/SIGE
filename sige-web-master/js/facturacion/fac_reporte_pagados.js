...
$(function(){
	...
	$('#frm-pagos-buscar').on('submit',function(event){
		...
		document.location.href = _URL + "api/archivo/excelPagados?id_niv=" + $('#id_niv').val() + '&id_gra=' + $('#id_gra').val() + '&id_au=' + $('#id_au').val()+'&mes='+$('#mes').val()+'&mat='+$('#mat').val()+'&ord='+$('#ord').val()+'&id_anio='+$("#_id_anio").text() ;
	});
