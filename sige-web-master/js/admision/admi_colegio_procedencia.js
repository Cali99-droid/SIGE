...
$('#frm-mat_consolidado').on('submit',function(event){
		...
		//alert($("#_id_suc").html());
		var param={id_anio:$('#_id_anio').text()};
		return _get('api/matrVacante/listarCantidadxColegio',fncExito, param);
	});
...
var fncExito = function(data){
	...
	$('#col_mat_consolidado').dataTable({
         ...
         columns : [ 
     	           ...
     	           {"title": "Codigo Modular", "data" : "cod_mod"},
				   {"title": "Colegio", "data" : "nom"},
				   ...
				   {"title": "Departamento", "data" : "departamento"},
     	           ...
     	           {"title": "Inscritos", "data" : "inscritos", "className": "text-center"}
