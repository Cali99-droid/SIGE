...
$('#frm-reporte-matriculados').on('submit',function(event){
		...
		var param={id_au:$('#id_au').val(), id_gra:$('#id_gra').val(), id_anio:$('#_id_anio').text(), id_gir:$('#id_gir').val(), id_niv:$('#id_nvl').val(), rep_com:$('#rep_com').val(), id_cic:$('#id_cic').val(), tras:$('#tras').val() };
